...
public class StoreDriver {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    for (Manager manager : managerList) {
      ...
      System.out.println("Tax Store: " + manager.calculateTax());
      pwd.println("Tax Store: " + manager.calculateTax());
      System.out.println("Work Hour per Day: " + manager.workHoursPerDay());
      pwd.println("Work Hour per Day: " + manager.workHoursPerDay());
      System.out.println("Overtime Pay: " + manager.calculateOvertimePay());
      pwd.println("Overtime Pay: " + manager.calculateOvertimePay());
      System.out.print(
    ...
    for (SalesAssociate salesAssociate : SalesAssociateList) {
      ...
      System.out.println(
        "Work Hour per Day: " + salesAssociate.workHoursPerDay()
      );
      pwd.println("Work Hour per Day: " + salesAssociate.workHoursPerDay());
      System.out.println(
        "Overtime Pay: " + salesAssociate.calculateOvertimePay()
      );
      pwd.println("Overtime Pay: " + salesAssociate.calculateOvertimePay());
      System.out.print(
    ...
    System.out.println(
      "Number of employees working as INTERN are: " + InternshipList.size()
    );
    System.out.println(
      "******************************************************"
    );
    ...
    for (Internship internship : InternshipList) {
      internshipCount++;
      System.out.println(internshipCount + ". Internship Details:");
      System.out.println(internship);
      pwd.println(internship);
      System.out.println("Gross Payment: $" + internship.calculatePay());
      pwd.println("Gross Payment: $" + internship.calculatePay());
      System.out.println("Work Hour per Day: " + internship.workHoursPerDay());
      pwd.println("Work Hour per Day: " + internship.workHoursPerDay());
      System.out.print(
        "Is " + internship.getEmployeeName() + " eligible for promotion? "
      );
      if (internship.checkPromotionEligibility() == true) {
        System.out.println("Yes, he/she is eligible\n");
      } else {
        System.out.println("No, he/she needs to work harder\n");
      }
