...
public class Manager extends AbstractStoreEmployee {
  ...
  public double calculateTax() {
    return getTotalStoreSales() * TAX;
  }

  @Override
  public double calculateOvertimePay() {
    double overtimeHours = (super.getNumberOfHoursWorked() - workHoursPerDay()); // Hours worked beyond regular working hours

    // Calculate regular pay and overtime pay
    double overtimePay = overtimeHours * super.getHourlyRate() * 2.0;
